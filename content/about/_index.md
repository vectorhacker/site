...
### Senior Software Engineer / AI Engineer, [Zeteo Health](https://zeteo.health), Bayamón, PR
...
- Migrated infrastructure from manual deployments to Infrastructure as Code using SST and Pulumi, which reduced deployment errors and made system setup more reliable.
- Optimized containerized applications using Docker to improve performance and reduce resource usage on our cloud servers.
- Developed custom Slack workflow using Python and JavaScript to automatically import new healthcare information sources into our chatbot's knowledgebase.
- Collaborated with data scientists to build data ingestion and processing pipelines on AWS using Python and Langchain for analyzing healthcare data.
...
- Architected cloud infrastructure and applications on Cloudflare platform for scalable, distributed computing that worked globally.
- Built comprehensive authentication and subscription management system using Discord OAuth, Login with Apple, and Stripe integration for secure user access and payments.
- Developed backend services using Hono and TypeScript hosted on Cloudflare Pages with D1 SQL storage and R2 blob storage.
- Created browser extension using WXT and Vue that enables users to remix web pages and save them as web clips to their local-first cluster.
...
- Architected completely serverless system on AWS using SST and AWS CDK for Infrastructure as Code to automatically manage cloud resources.
- Integrated platform with EMS systems through HL7 message processing for seamless healthcare data exchange between hospitals and labs.
- Developed backend services using TypeScript, Go, and Python on AWS Lambda to handle orders, external system integration, HL7 messages, transactions, and notifications.
- Collaborated with data team to deliver business intelligence solutions for order processing, tracking, analytics, and infrastructure management.
- Built comprehensive CI/CD pipeline for automated integration, testing, and deployment that ran on each code change.
- Instituted Test-Driven Development (TDD) practices and established documentation guidelines through internal wiki to improve code quality.
...
- Developed COVID testing application for ordering and managing COVID tests and results during the pandemic.
...
- Refactored and modernized legacy C# and SQL Server software for an internal mail digitization service (InMail), applying SOLID principles and Clean Architecture to enhance maintainability and scalability.
- Collaborated on the SURI project to enable a unified online portal for tax filing and treasury interactions, utilized by thousands of individual and corporate taxpayers.
...
- Developed and deployed data fixes to resolve critical issues, ensuring data integrity and seamless operations.
- Applied version control best practices using Subversion to manage and track software development changes effectively across multiple developers.
...
- Partnered with Buena Vibra Group to design and develop mobile applications that enhanced user engagement and supported media campaigns.
- Optimized Google Analytics integrations to track campaign performance, improve user insights, and drive higher conversion rates for media clients.
- Developed and maintained full-stack applications using Go, Node.js, Angular, and Vue, ensuring scalable and efficient solutions tailored to client needs.
...
- Attended AWS cloud conferences to stay current with emerging cloud technologies and best practices.
...
- Installed GPS devices on 10 buses and tracked their routes throughout the Puerto Rico metro area.
